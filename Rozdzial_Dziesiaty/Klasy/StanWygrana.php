...
class StanWygrana extends Stan {
    ...
    public function wydaj() {
        printf("WYGRAŁEŚ! Dostajesz drugą gumę<br/>");
    ...
    public function __toString() {
        return 'wydaje dwie gumy za twoją monetę, ponieważ JESTEŚ ZWYCIĘZCĄ!';
    }
}
